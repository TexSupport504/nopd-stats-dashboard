  ...
  const processedData = useMemo(() => {
    if (!data) {
      ...
      return {
        ...
        dayOfWeekData: [
          { day: 'Monday', violent: 45, nonViolent: 89, total: 134 },
          { day: 'Tuesday', violent: 38, nonViolent: 76, total: 114 },
          { day: 'Wednesday', violent: 42, nonViolent: 82, total: 124 },
          { day: 'Thursday', violent: 48, nonViolent: 91, total: 139 },
          { day: 'Friday', violent: 67, nonViolent: 124, total: 191 }, // Peak day
          { day: 'Saturday', violent: 89, nonViolent: 156, total: 245 }, // Highest
          { day: 'Sunday', violent: 54, nonViolent: 98, total: 152 }
        ],
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <ResponsiveContainer width="100%" height={300}>
          <BarChart data={sampleData.dayOfWeekData || []}>
            <CartesianGrid strokeDasharray="3 3" />
            <XAxis dataKey="day" />
            <YAxis />
            <Tooltip 
        ...
        <div className="mt-4 p-4 bg-purple-50 rounded-lg">
          <h4 className="font-medium text-purple-800 mb-2">Weekly Patterns</h4>
          <p className="text-sm text-purple-600">
            📊 Highest activity: <span className="font-bold">Saturday</span> with 245 total incidents<br/>
            📅 Weekdays vs Weekends: Weekends show higher violent crime rates<br/>
            ⏰ Pattern indicates increased activity during weekend hours
          </p>
        </div>
      </div>
